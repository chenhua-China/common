...
public final class Reflections {
  ...
  public static Object getFieldValue(final Object obj, final String fieldName) {
    ...
    if (field == null) {
      throw new IllegalArgumentException(
          String.format("Could not find field [%s] on target [%s]", fieldName, obj));
    }
  ...
  public static Object invokeMethod(
    ...
    if (method == null) {
      throw new IllegalArgumentException(
          String.format("Could not find method [%s] on target [%s]", methodName, obj));
    }
  ...
  public static Field getAccessibleField(final Object obj, final String fieldName) {
    ...
    LOGGER.warn(
        "getAccessibleField ; not find field about {}  from {} or the parent",
  ...
  public static Method getAccessibleMethod(
    ...
    LOGGER.warn(
        "getAccessibleField ; not find method about {}  from {} or the parent",
        obj.getClass().getName(),
        methodName);
    return null;
  }
