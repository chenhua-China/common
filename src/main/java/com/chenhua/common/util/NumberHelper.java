...
public class NumberHelper extends NumberUtils {
  ...
  /**
   * 使用系统默认方式格式化一个数字为字符串,小数位2,不使用千分位. 这个是整个应用系统的"风格",一般情况下,前台显示,只能使用该函数.
   *
   * @param number 要处理的数字.
   * @return 格式化数字 string
   */
   ...
   * 格式化数字
   *
   * <p>格式化前：1231423.3823 "#.##" 格式化后：1231423.38 "0000000000.000000" 格式化后：0001231423.382300
   * "-##,###.##" 格式化后：-1,231,423.382 "#.##E000" 格式化后：1.23E006 模式中的"#"表示如果该位存在字符，则显示字符，如果不存在，则不显示。
   *
   * @param number 要处理的数字.
   * @param format 格式
   * @return 格式化数字 string
